...
ingreso = open("C:/Users/Lab/Desktop/Compi/Final/PythonOldTimes/ProyectoParcial/ingreso.txt")
...
def part_one(): #inicio del assembly
    file = open("C:/Users/Lab/Desktop/Compi/Final/PythonOldTimes/ProyectoParcial/assambly.txt", "a")
    file.write(".data\n")
    file.close()
